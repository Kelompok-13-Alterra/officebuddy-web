  ...
  return (
    <div className="p-3 w-full bg-bg-fourth">
      <div className="flex justify-center w-[600px flex-col mx-auto items-center">
        <p className="md:text-4xl text-2xl text-center text-white font-face-ro-bold mb-3">
          Kamu Bisa Menyewa Kantor Dengan
        </p>
        <p className="md:text-4xl text-2xl text-center text-white font-face-ro-bold">
          Cara yang Mudah
        </p>
      </div>
